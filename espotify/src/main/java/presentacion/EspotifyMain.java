...
public class EspotifyMain {
    ...
    public static void main(String[] args) {
     ...
     IControladorAlbum controlAlb;
     IControladorGenero controlGen;
     IControladorCliente controlCli;
     IControladorArtista controlArt;
     IControladorTema controlTem;
     IControladorListaParticular controlListPar;
     IControladorListaPorDefecto controlListPD;
     IControladorSuscripcion controlSus;
